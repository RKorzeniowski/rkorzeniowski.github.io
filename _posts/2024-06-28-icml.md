...
<div style="float: right;" width="30%">
  ...
  <p style="margin-top: 10px; font-size: 16px; color: #444;">
    Video. 1. Zeroshot example generated with VideoPoet only using text prompt "A bear with the head of an owl screeches   loudly" as an input. ([Source Link](https://sites.research.google/videopoet/))
  </p>
</div>
