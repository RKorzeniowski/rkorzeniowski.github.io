...
<div style="float: right; width: 20%; max-width: 100%;">
  <video style="float: right" width="100%" controls>
...
<div style="display: flex; align-items: center;">
  <!-- Left Side: Blog Text -->
  <div style="flex: 1; padding-right: 20px; font-size: 16px; color: #333;">
    <p>
    ...
    <p>
      You can continue writing your article here while keeping the video neatly aligned to the right.
    </p>
  </div>
  ...
  <div style="flex: 1; text-align: center;">
    ...
    <p style="margin-top: 10px; font-size: 14px; color: #444;">
      This is a description of the video. It stays directly below the video.
    </p>
  </div>
</div>
...
<video style="float: right" width="35%" controls>
	<source src="https://raw.githubusercontent.com/RKorzeniowski/rkorzeniowski/refs/heads/main/images/icml-2024/video_poet-video.mp4" type="video/mp4">
</video>
